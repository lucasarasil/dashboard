        ...
        <div className="bg-gray-100 rounded-lg h-64 flex items-center justify-center relative overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-green-100 to-blue-100">
            ...
            <div className="absolute top-1/4 left-1/3 transform -translate-x-1/2 -translate-y-1/2">
              ...
              <div className="text-xs bg-white px-2 py-1 rounded mt-1 shadow">Filial</div>
            </div>
            ...
            <div className="absolute top-1/2 right-1/4 transform -translate-x-1/2 -translate-y-1/2">
              ...
              <div className="text-xs bg-white px-2 py-1 rounded mt-1 shadow">Serviço</div>
            </div>
            ...
            <div className="absolute bottom-1/3 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
              ...
              <div className="text-xs bg-white px-2 py-1 rounded mt-1 shadow">Veículo</div>
            </div>
          </div>
          ...
          <div className="absolute bottom-4 right-4 bg-white rounded-lg shadow-lg p-2">
            <div className="space-y-1">
              <button className="block w-8 h-8 bg-gray-100 hover:bg-gray-200 rounded text-gray-600">+</button>
              <button className="block w-8 h-8 bg-gray-100 hover:bg-gray-200 rounded text-gray-600">-</button>
            </div>
          </div>
        </div>
            ...
            <div className="flex items-start space-x-3">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between">
                  ...
                  <span className={`status-badge ${getStatusColor(location.status)} text-xs`}>
                    {location.status === 'base' ? 'Base' : 
                     location.status === 'active' ? 'Ativo' : 'Em movimento'}
                  </span>
                </div>
